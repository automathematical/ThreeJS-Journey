...
void main()
{
    ...
    // // Pattern 31
    // vec2 lightUvX = vec2(vUv.x *.1 + 0.45, vUv.y *.5 + 0.25);
    // float lightX = 0.015 / distance(lightUvX, vec2(0.5));

    // vec2 lightUvY = vec2(vUv.y *.1 + 0.45, vUv.x *.5 + 0.25);
    ...
    // vec2 lightUvX = vec2(rotatedUv.x *.1 + 0.45, rotatedUv.y *.5 + 0.25);
    // float lightX = 0.015 / distance(lightUvX, vec2(0.5));

    // vec2 lightUvY = vec2(rotatedUv.y *.1 + 0.45, rotatedUv.x *.5 + 0.25);
    // float lightY = 0.015 / distance(lightUvY, vec2(0.5));
